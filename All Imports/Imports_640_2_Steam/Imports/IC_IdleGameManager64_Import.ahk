...
this.game.gameInstances.Controller.area.activeMonsters.monsterDef.HealthRanges := New GameObjectStructure(this.game.gameInstances.Controller.area.activeMonsters.monsterDef,"List", [0x40])
