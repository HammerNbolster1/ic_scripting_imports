...
this.game.gameInstances.Controller.userData.ActiveUserGameInstance := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x2f4])
...
this.game.gameInstances.Controller.userData.BuffHandler.inventoryBuffs.inventoryAmount := New GameObjectStructure(this.game.gameInstances.Controller.userData.BuffHandler.inventoryBuffs,"Int", [0x118])
...
this.game.gameInstances.Controller.userData.DailyLoginHandler := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x140])
this.game.gameInstances.Controller.userData.DailyLoginHandler.CurrentDay := New GameObjectStructure(this.game.gameInstances.Controller.userData.DailyLoginHandler,"Int", [0x50])
this.game.gameInstances.Controller.userData.DailyLoginHandler.PremiumRewardsClaimed := New GameObjectStructure(this.game.gameInstances.Controller.userData.DailyLoginHandler,"Int", [0x4c])
this.game.gameInstances.Controller.userData.DailyLoginHandler.RewardsClaimed := New GameObjectStructure(this.game.gameInstances.Controller.userData.DailyLoginHandler,"Int", [0x48])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.Benched := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Char", [0x378])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.health := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Double", [0x3c0])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.lastMaxHealth := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Double", [0x3d8])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.lastHealthPercent := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Double", [0x3c8])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.level := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x39c])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.overwhelm := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x364])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.Owned := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Char", [0x368])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.slotId := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x36c])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.def.SeatID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.def,"Int", [0x208])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.KeyHash := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def,"Int", [0x78])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.effectParams := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def,"Dict", [0x70])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.effectParams._CollectionKeyType := "System.Int32"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.effectParams._CollectionValType := "CrusadersGame.Defs.EffectKeyDef.EffectKeyParam"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.effectParams.Name := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.effectParams,"UTF-16", [0x10])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades,"Int", [0x40])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler,"Dict", [0x20])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId._CollectionKeyType := "System.Int32"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId._CollectionValType := "CrusadersGame.GameScreen.HeroUpgrade"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId.Id := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId,"Int", [0x40])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId.RequiredLevel := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId,"Int", [0x44])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId.IsSpecialization := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.PurchasedUpgrades.handler.upgradesByUpgradeId,"Char", [0x48])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler,"HashSet", [0x38])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades._CollectionKeyType := "System.Int32"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades,"Int", [0x40])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler.upgradesByUpgradeId := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler,"Dict", [0x20])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler.upgradesByUpgradeId._CollectionKeyType := "System.Int32"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler.upgradesByUpgradeId._CollectionValType := "CrusadersGame.GameScreen.HeroUpgrade"
this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler.upgradesByUpgradeId.RequiredLevel := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.upgradeHandler.UnlockedUpgrades.handler.upgradesByUpgradeId,"Int", [0x44])
...
this.game.gameInstances.Controller.userData.inited := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Char", [0x2e0])
...
this.game.gameInstances.Controller.userData.redRubies := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x2bc])
this.game.gameInstances.Controller.userData.redRubiesSpent := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x2c0])
...
this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs := New GameObjectStructure(this.game.gameInstances.Controller.userData.ResetCurrencyHandler,"List", [0x18])
...
this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs.AmountEarned := New GameObjectStructure(this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs,"Double", [0x80])
this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs.ID := New GameObjectStructure(this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs,"Int", [0x10])
this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs.ForceConvert := New GameObjectStructure(this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs,"Char", [0xa8])
this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs.Name := New GameObjectStructure(this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs,"UTF-16", [0x18])
this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs.ShortName := New GameObjectStructure(this.game.gameInstances.Controller.userData.ResetCurrencyHandler.ResetCurrencyDefs,"UTF-16", [0x20])
...
this.game.gameInstances.Controller.userData.ShopHandler := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x108])
this.game.gameInstances.Controller.userData.ShopHandler.ALaCarteHandler_k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.userData.ShopHandler,"Int", [0x18])
this.game.gameInstances.Controller.userData.ShopHandler.ALaCarteHandler_k__BackingField.RerollCost_k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.userData.ShopHandler.ALaCarteHandler_k__BackingField,"Int", [0x30])
this.game.gameInstances.Controller.userData.ShopHandler.ALaCarteHandler_k__BackingField.RerollsRemaining_k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.userData.ShopHandler.ALaCarteHandler_k__BackingField,"Int", [0x2c])
...
this.game.gameInstances.Controller.userData.StatHandler.BlackViperTotalGems := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x2f8])
this.game.gameInstances.Controller.userData.StatHandler.BrivSteelbonesStacks := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x360])
this.game.gameInstances.Controller.userData.StatHandler.BrivSprintStacks := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x364])
...
this.game.gameInstances.Controller.userData.TrialsHandler := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0xf8])
this.game.gameInstances.Controller.userData.TrialsHandler.pendingUnclaimedCampaignID := New GameObjectStructure(this.game.gameInstances.Controller.userData.TrialsHandler,"Int", [0x140])
...
this.game.gameInstances.BuffHandler.activeBuffs.RemainingTime := New GameObjectStructure(this.game.gameInstances.BuffHandler.activeBuffs,"Float", [0x10c])
this.game.gameInstances.BuffHandler.activeBuffs.Duration := New GameObjectStructure(this.game.gameInstances.BuffHandler.activeBuffs,"Int", [0xc4])
this.game.gameInstances.BuffHandler.activeBuffs.TotalDuration := New GameObjectStructure(this.game.gameInstances.BuffHandler.activeBuffs,"Int", [0x108])
...
this.game.gameInstances.Controller.area.activeMonsters.monsterDef.HealthRanges := New GameObjectStructure(this.game.gameInstances.Controller.area.activeMonsters.monsterDef,"List", [0x48])
...
this.game.gameInstances.ActiveCampaignData.currentArea.QuestRemaining := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentArea,"Int", [0x64])
this.game.gameInstances.ActiveCampaignData.currentArea.level := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentArea,"Int", [0x5c])
...
this.game.gameInstances.ActiveCampaignData.currentRules.MonsterDamageModifier := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Double", [0x3b8])
this.game.gameInstances.ActiveCampaignData.currentRules.monsterbaseStats := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Int", [0xe0])
...
this.game.gameInstances.FormationSaveHandler.mostRecentFormation := New GameObjectStructure(this.game.gameInstances.FormationSaveHandler,"Int", [0x48])
this.game.gameInstances.FormationSaveHandler.mostRecentFormation.Favorite := New GameObjectStructure(this.game.gameInstances.FormationSaveHandler.mostRecentFormation,"Int", [0x48])
this.game.gameInstances.FormationSaveHandler.mostRecentFormation.Formation := New GameObjectStructure(this.game.gameInstances.FormationSaveHandler.mostRecentFormation,"List", [0x18])
this.game.gameInstances.FormationSaveHandler.mostRecentFormation.Formation._CollectionValType := "System.Int32"
this.game.gameInstances.FormationSaveHandler.mostRecentFormation.SaveID := New GameObjectStructure(this.game.gameInstances.FormationSaveHandler.mostRecentFormation,"Int", [0x40])
...
this.game.gameInstances.Controller.formation.slots.slotDef := New GameObjectStructure(this.game.gameInstances.Controller.formation.slots,"Int", [0x118])
...
this.game.gameInstances.Controller.formation.TransitionOverrides := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Dict", [0xe8])
...
this.game.gameInstances.Controller.formation.transitionDir := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Int", [0x1f4])
this.game.gameInstances.Controller.formation.inAreaTransition := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Char", [0x1f8])
this.game.gameInstances.Controller.formation.numAttackingMonstersReached := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Int", [0x200])
this.game.gameInstances.Controller.formation.numRangedAttackingMonsters := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Int", [0x204])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.upgradeButton := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes,"Int", [0x358])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.upgradeButton.enabled := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.upgradeButton,"Char", [0x360])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.hero.upgradeHandler := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.hero,"Int", [0x338])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.hero.upgradeHandler.PurchasedUpgrades := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.hero.upgradeHandler,"HashSet", [0x40])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.hero.upgradeHandler.PurchasedUpgrades._CollectionKeyType := "System.Int32"
