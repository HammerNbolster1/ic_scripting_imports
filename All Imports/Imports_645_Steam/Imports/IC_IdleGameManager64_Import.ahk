...
this.game.gameInstances.ActiveCampaignData.currentRules.MonsterDamageModifier := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Double", [0x3c0])
this.game.gameInstances.ActiveCampaignData.currentRules.monsterbaseStats := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Int", [0xe8])
...
this.game.gameInstances.Controller.formation.slots.slotDef := New GameObjectStructure(this.game.gameInstances.Controller.formation.slots,"Int", [0x120])
