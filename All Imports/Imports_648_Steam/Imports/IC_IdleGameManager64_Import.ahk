...
this.game.gameInstances.Controller.formation.slots.heroAlive := New GameObjectStructure(this.game.gameInstances.Controller.formation.slots,"Char", [0x259])
...
this.game.gameInstances.Controller.formation.transitionDir := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Int", [0x1fc])
this.game.gameInstances.Controller.formation.inAreaTransition := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Char", [0x200])
this.game.gameInstances.Controller.formation.numAttackingMonstersReached := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Int", [0x208])
