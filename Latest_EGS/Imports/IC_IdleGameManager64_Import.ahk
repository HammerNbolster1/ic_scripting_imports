...
this.game.gameInstances.ActiveCampaignData.currentRules.MonsterDamageModifier := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Double", [0x380])
this.game.gameInstances.ActiveCampaignData.currentRules.monsterbaseStats := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Int", [0xc8])
